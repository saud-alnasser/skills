...
| [0069](0069-this-repository-pins-its-checkout-ending-so-a-derived-script-can-emit-it.md) | the working tree's line endings are in question, or what a derived script may emit | accepted | `.claude/scripts/regenerate-indexes.ps1`, `skills/configure/SCRIPTS.md`, `.claude/tickets/declared-fields/issues/05-the-index-regenerator-and-its-comparison.md`, `.claude/tickets/line-endings/spec.md` |
...
| [0080](0080-a-framework-file-declares-the-release-that-last-changed-it.md) | a version or provenance field on shipped or installed files is proposed, or the release check's scope is in question | accepted | `skills/configure/`, `scripts/verify.ps1`, `.claude/decisions/0064-the-release-check-is-a-hook-because-only-shipped-content-knows-the-release.md` |

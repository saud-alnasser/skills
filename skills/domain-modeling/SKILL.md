...
Decisions sit beside Context rather than below it because `CLAUDE.md` presents the two as peers, and a tree that buries one of them contradicts the model on the page a reader meets first.
